...
public class RestConnector {
	...
	public Response httpGet(String url, String queryString, Map<String,
			String> headers)throws Exception {
		System.out.println("call to httpget");
	...
	private Response doHttp(
		...
		System.out.println("inside dohttp");
		System.out.println(queryString);
		System.out.println(url);
		if ((queryString != null) && !queryString.isEmpty()) {
			System.out.println("inside if of query string ");
			url += "?" + queryString;
			System.out.println(url);
		}
		...
		String responseStr = ret.toString();
	...
	private void updateCookies(Response response) {
		...
		if (newCookies != null) {
			...
			for (String cookie : newCookies) {
				...
				if(cookieKey.equalsIgnoreCase("QCSession"))
				{
					System.out.println(cookieValue);
					QC_Operations_POC.QCSESSION_Key=cookieKey+"="+cookieValue;
				}
